...
rho_plus_tri = 1 / 2 * (phi_g1 ** 2) + 1 / 2 * (phi_plus ** 2)
rho_minus_tri = 1 / 2 * (phi_g1 ** 2) + 1 / 2 * (phi_minus ** 2)
rho_im1_tri = 1 / 2 * (phi_g1 ** 2) + 1 / 2 * (phi_im * phi_im.conj())
rho_im1_tri = np.real(rho_im1_tri)