import unittest
import numpy as np
from src.orbitals import PrimitiveGaussian, AtomicOrbital
...
class TestAtomicOrbital(unittest.TestCase):
    ...
    def test_get_value(self):
        ...
        value1 = gaussian_3d(c1, alpha1, R1, r1)
        value2 = gaussian_3d(c2, alpha2, R2, r2)
        value3 = gaussian_3d(pg3.coeff, pg3.alpha, pg3.coordinates, r3)
    ...
    def test_multiplacation2(self):
        ...
        pg2 = PrimitiveGaussian(alpha2, c2, R2)
        pg3 = pg1 * pg2
        ao1 = AtomicOrbital([pg1], [0])
        ao2 = AtomicOrbital([pg2], [1])
        ao3 = AtomicOrbital([pg3], [2])
